<template>
    <div class="container py-4">
        ...
        <div class="row mt-5">
            ...
            <div class="col-4">
                <indicador titulo="Profissionais cadastrados" indicador="255" bg="bg-dark" color="text-white">
                </indicador>
            </div>
            <div class="col-4">
                <indicador titulo="Visitantes onlines" :indicador="usuariosOnline" bg="bg-light" color="text-dark">
                </indicador>
            </div>
        </div>
    </div>
